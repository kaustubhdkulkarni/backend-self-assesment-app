...
const envVarsSchema = Joi.object()
  .keys({
    ...
    JWT_ACCESS_EXPIRATION_MINUTES: Joi.string().default(60).description('minutes after which access tokens expire'),
    JWT_REFRESH_EXPIRATION_DAYS: Joi.string().default(60).description('days after which refresh tokens expire'),
...
module.exports = {
  ...
  mongoose: {
    ...
    options: {
      ...
      serverSelectionTimeoutMS: 600000 // 10min
    },
  },
  jwt: {
  ...
  email: {
    smtp: {
      ...
      logger: envVars.NODE_ENV !== 'test',
      debug: envVars.NODE_ENV === 'test',
    },
