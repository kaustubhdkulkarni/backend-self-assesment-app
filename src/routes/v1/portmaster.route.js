...
const Controller = require('../../modules/portMaster/controllers');
...
router.route('/collectionnamelist').get(auth("adminAccess"), Controller.listPortMasterControllerForCollectionName)
